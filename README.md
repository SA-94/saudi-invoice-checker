...
### ▶ [افتح الموقع مباشرة](https://sa-94.github.io/saudi-invoice-checker/)

نسخة تشتغل داخل متصفحك بدون تنصيب أي شي — **الفواتير ما تغادر جهازك، ولا تُرفع لأي خادم.**

---

أداة تفحص الفواتير الضريبية السعودية وتستخرج بياناتها إلى إكسل تلقائياً.
